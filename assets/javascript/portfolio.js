...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'youtube',
                link: 'https://www.youtube.com/c/yungleannn'
            },
		    {
                name: 'spotify',
                link: 'https://open.spotify.com/user/tgjazqcmfbps0z5tmuay3y9j1?si=071773dd0aaa4990'
            },
		    {
                name: 'soundcloud',
                link: 'https://soundcloud.com/rivp'
            },

            {
                name: 'tiktok',
                link: 'https://www.tiktok.com/@summrs.fan69'
            },
            
            {
                name: 'discord',
                link: 'https://discord.gg/YP7CSD7YGY'
            },
            
            {
                name: 'v3rmillion',
                link: 'https://v3rmillion.net/member.php?action=profile&uid=1504544'
            },
            
            {
                name: 'solo',
                link: 'https://solo.to/greedy'
            },
        ...
        if (window.mobileAndTabletCheck()) {
            $("#background").replaceWith('<div id="background" style="background-image: url(https://staymad.club/assets/icons/favicon.png"></div>');
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2bdc619693544329841a3196dca3f6c0', function (data) { 
            ...
            writeLine(["Authenticating...", "Attempting to grant access to <span style='font-size: 14px; color: #3b66cc;'>[astella.gq]</span>..."], 30, function () {
